  ...
  return (
    <>
      ...
      <div className="container treatment-section-overview">
        ...
        <p>
          Here at Beach Street Rehab, we firmly stand that without addressing
          ...
          <br />
          <br />
          Methods used by Beach Street Rehab are non-invasive, distinct, and
      ...
      <div className="treatment-section-activities">
        <div className="treatment-left">
          ...
          <p>
            Beach Street Rehab promotes fun activities that clients learn how to

    ...
    <div className="op-section">
      <div className="op-section-content container">
            ...
            <div className="op-section-header">
              ...
              <h1>About Us</h1>
              <p>At Beach Street Rehab, we believe in a holistic approach to recovery, addressing not only the physical aspects of addiction but also the emotional, mental, and social factors that contribute to it. Our team of experienced professionals is committed to creating a safe and supportive environment for individuals seeking outpatient treatment.</p>
            </div>
        ...
        <div className="op-section-flex">
          ...
          <div className="op-section-flex-left">
            ...
            <p>Taking the first step towards recovery is a courageous decision. To get started with our Outpatient Treatment Program, please contact us at <a href='tel:3239025644'>+1 (323) 902-5644</a> to schedule an initial assessment. Our team will work with you to create a personalized treatment plan that aligns with your goals.</p><br/>
            <p>At Beach Street Rehab, we are here to support you every step of the way. Regain control of your life and start your journey to lasting recovery with us.</p>
